...
fun getRusFilms(): List<Film> = listOf(
    ...
    Film("Сова", "мьюзикл", 1950, R.drawable.sova, "Жила – была в " +
    ...
    Film("Ворон", "история", 2021, R.drawable.voron, "Жила на свете ворона. " +
    ...
    Film("Хрюша", "документальный", 1991, R.drawable.hrusha, "Хрюша – " +
